...
return array(
    ...
    'App\\Http\\Requests\\NextRoundRequest' => $baseDir . '/app/Http/Requests/NextRoundRequest.php',
    ...
    'Okipa\\LaravelHtmlHelper\\HtmlClasses' => $vendorDir . '/okipa/laravel-html-helper/src/HtmlClasses.php',
    'Okipa\\LaravelTable\\Abstracts\\AbstractTable' => $vendorDir . '/okipa/laravel-table/src/Abstracts/AbstractTable.php',
    'Okipa\\LaravelTable\\Column' => $vendorDir . '/okipa/laravel-table/src/Column.php',
    'Okipa\\LaravelTable\\Console\\Commands\\MakeTable' => $vendorDir . '/okipa/laravel-table/src/Console/Commands/MakeTable.php',
    'Okipa\\LaravelTable\\LaravelTableServiceProvider' => $vendorDir . '/okipa/laravel-table/src/LaravelTableServiceProvider.php',
    'Okipa\\LaravelTable\\Result' => $vendorDir . '/okipa/laravel-table/src/Result.php',
    'Okipa\\LaravelTable\\Table' => $vendorDir . '/okipa/laravel-table/src/Table.php',
    'Okipa\\LaravelTable\\Traits\\Column\\AppendsHtml' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/AppendsHtml.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasClasses' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasClasses.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasCustomHtml' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasCustomHtml.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasCustomValue' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasCustomValue.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasDateTimeFormat' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasDateTimeFormat.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasStringLimit' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasStringLimit.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasTable' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasTable.php',
    'Okipa\\LaravelTable\\Traits\\Column\\HasTitle' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/HasTitle.php',
    'Okipa\\LaravelTable\\Traits\\Column\\IsButton' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/IsButton.php',
    'Okipa\\LaravelTable\\Traits\\Column\\IsLink' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/IsLink.php',
    'Okipa\\LaravelTable\\Traits\\Column\\IsLinkedToDatabase' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/IsLinkedToDatabase.php',
    'Okipa\\LaravelTable\\Traits\\Column\\IsSearchable' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/IsSearchable.php',
    'Okipa\\LaravelTable\\Traits\\Column\\IsSortable' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/IsSortable.php',
    'Okipa\\LaravelTable\\Traits\\Column\\PrependsHtml' => $vendorDir . '/okipa/laravel-table/src/Traits/Column/PrependsHtml.php',
    'Okipa\\LaravelTable\\Traits\\Result\\HasClasses' => $vendorDir . '/okipa/laravel-table/src/Traits/Result/HasClasses.php',
    'Okipa\\LaravelTable\\Traits\\Result\\HasCustomHtml' => $vendorDir . '/okipa/laravel-table/src/Traits/Result/HasCustomHtml.php',
    'Okipa\\LaravelTable\\Traits\\Result\\HasTitle' => $vendorDir . '/okipa/laravel-table/src/Traits/Result/HasTitle.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasAdditionalQueries' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasAdditionalQueries.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasClasses' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasClasses.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasColumns' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasColumns.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasDestroyConfirmation' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasDestroyConfirmation.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasDisabledRows' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasDisabledRows.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasIdentifier' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasIdentifier.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasModel' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasModel.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasPagination' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasPagination.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasRequest' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasRequest.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasResults' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasResults.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasRoutes' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasRoutes.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasRowsNumberDefinition' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasRowsNumberDefinition.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasSearching' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasSearching.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasSorting' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasSorting.php',
    'Okipa\\LaravelTable\\Traits\\Table\\HasTemplates' => $vendorDir . '/okipa/laravel-table/src/Traits/Table/HasTemplates.php',
